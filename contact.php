...
<?php
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="contact.php"><em class="fa fa-clone"></em> Contact</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-default">
					<div class="panel-heading"><span class="glyphicon glyphicon-envelope"></span> Contact Us</div>
					<div class="panel-body">
						<form class="form-horizontal" action="./components/ContactForm/ContactForm.php" method="POST">
							<fieldset>
								<!-- Name input-->
								<div class="form-group">								
									<div class="col-md-6">
								...
								<div class="form-group">
									<div class="col-md-12">
										<button type="submit" class="btn btn-default btn-md" name="process">Submit</button>
									</div>
								</div>
							</fieldset>
						</form>
